...
ScrollReveal().reveal(
  ".home-img, .services-container, .portfolio-box, #contact-whatsapp",
  { origin: "bottom" }
);
ScrollReveal().reveal(".home-content h1, .about-img, #contact-email", {
  origin: "left",
});
ScrollReveal().reveal(".home-content p, .about-content, #contact-fb", {
  origin: "right",
});
...
function toggleDarkModeM() {
  ...
  if (icon.classList.contains("bx-moon")) {
    // Apply light mode styles (default mode)
